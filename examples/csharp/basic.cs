...
{
    class SlotMachineSimulatorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/slotmachine";

        /// <summary>
        /// Make a GET request to the Slot Machine Simulator API
        /// </summary>
        static async Task<JsonDocument> CallSlotMachineSimulatorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;spins&quot;] &#x3D; 5, [&quot;reels&quot;] &#x3D; 3, [&quot;bet&quot;] &#x3D; 1 };
        ...
        {
            Console.WriteLine("📤 Calling Slot Machine Simulator API...\n");

            var result = await CallSlotMachineSimulatorAPI();
