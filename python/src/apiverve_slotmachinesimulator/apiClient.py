...
class SlotmachineAPIClient:
    ...
    VALIDATION_RULES = {
        "spins": {"type": "integer", "required": False, "min": 1, "max": 5, "default": 1},
        "reels": {"type": "integer", "required": False, "min": 3, "max": 5, "default": 3},
        "bet": {"type": "number", "required": False, "min": 0, "max": 1000, "default": 1}
    }
