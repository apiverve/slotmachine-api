...
class TestSlotmachineAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = SlotmachineAPIClient(self.api_key)

    @patch('apiverve_slotmachinesimulator.apiClient.requests.get')
