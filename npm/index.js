...
class slotmachineWrapper {
    ...
    constructor(options) {
        ...
        this.validationRules = {"spins":{"type":"integer","required":false,"min":1,"max":5,"default":1},"reels":{"type":"integer","required":false,"min":3,"max":5,"default":3},"bet":{"type":"number","required":false,"min":0,"max":1000,"default":1}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/slotmachine`);
        }
    }
