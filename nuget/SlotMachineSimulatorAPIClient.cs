...
namespace APIVerve.API.SlotMachineSimulator
{
    ...
    /// <summary>
    /// Client for the SlotMachineSimulator API
    /// </summary>
...
#endif
    {
        ...
        {
            { "spins", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 5 } },
            { "reels", new ValidationRule { Type = "integer", Required = false, Min = 3, Max = 5 } },
            { "bet", new ValidationRule { Type = "number", Required = false, Min = 0, Max = 1000 } }
        };
        ...
        private void ValidateParams(SlotMachineSimulatorQueryOptions options)
        {
